    ...
    <aside className="w-60 min-h-screen bg-slate-900 text-slate-100 flex flex-col">
      ...
      <div className="px-4 py-4 border-t border-slate-800 space-y-3">
        ...
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm text-slate-400 hover:bg-slate-800 hover:text-slate-100 transition-colors"
        >
        ...
        <p className="text-xs text-slate-600 px-2">v0.1.0</p>
      </div>
    </aside>
  );
}
